      ...
      <div className="right">
        <form action="">
          <div>
            ...
            <p className="text1">Fill your additional details</p>
          </div>
          <div className="input1">
            <div>
              <h1 className="nametag">First Name</h1>
              <input
                className="input-box"
                type="text"
            ...
            <div className="input2">
              <h1 className="nametag">Last Name</h1>
              <input
                className="input-box"
                type="text"
            ...
            <div className="input2">
              <h1 className="nametag">Phone Number</h1>
              <input
                className="input-box"
                type="text"
